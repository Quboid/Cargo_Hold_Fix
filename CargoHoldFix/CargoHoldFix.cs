...
namespace CargoHoldFix
{
    public class CargoHoldFix : LoadingExtensionBase, IUserMod
    {
        ...
        public void OnSettingsUI(UIHelperBase helper)
        {
            ...
            group = helper.AddGroup("Disabled");
            UIPanel panel = ((UIPanel)((UIHelper)group).self) as UIPanel;
            UILabel label = panel.AddUIComponent<UILabel>();
            label.text = "Optimised Outside Connections is presently disabled.\n\n" +
                "The recent Cities Skylines update (1.14) has changed how outside connections\n" +
                "work and analysis is needed to determine if this mod needs updated or if it is\n" +
                "even needed at all.\n\n" +
                "Please let me know on this mod's Steam workshop discussion page if you feel it\n" +
                "is still important.";
