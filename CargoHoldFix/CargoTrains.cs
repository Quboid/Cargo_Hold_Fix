...
namespace CargoHoldFix
{
    ...
    //public class CTAI_TrySpawn
    //{
    //    static int spawned = 0;
    //    static int full = 0;
    //    static int dummy = 0;

    //    public static bool Postfix(bool result, ushort vehicleID, ref Vehicle vehicleData, int ___m_cargoCapacity)
    //    {
    //        if (result)
    //        {
    ...
    //            {
    //                spawned++;
    //                if (vehicleData.m_transferSize == ___m_cargoCapacity)
    //                {
    //                    full++;
    //                }
    //            }
    ...
    //        if (!HasFlag(vehicleData, Vehicle.Flags.DummyTraffic))
    //        {
    //            Debug.Log($"TRAINS: {full}/{spawned} full ({dummy} dummies)\n#{vehicleID}: {vehicleData.m_transferSize}/{___m_cargoCapacity} - {result}\n{vehicleData.m_flags}");
    //        }
